    ...
    <div class="h-screen bg-pink-100 flex justify-center items-center">
        <div class="lg:w-2/5 md:w-1/2 w-2/3">
            <form method="post" action="{{route('login')}}" class="bg-white p-10 rounded-lg shadow-lg min-w-full" enctype="multipart/form-data">
                ...
                <div class="mb-4 flex items-center m-4">
                ...
                <button type="submit" class="w-full mt-6 mb-3 bg-indigo-100 rounded-lg px-4 py-2 text-lg text-gray-800 tracking-wide font-semibold font-sans"><a href="{{'register'}}">Register</a></button>
            </form>

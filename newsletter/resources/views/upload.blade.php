...
<div class="relative mx-auto w-full min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-gray-500 bg-no-repeat bg-cover relative items-center"
    ...
    <div class="sm:max-w-lg w-full p-10 bg-white rounded-xl z-10">
        ...
        <form class="mt-8 space-y-3" action="{{ route('upload') }}" method="POST" enctype="multipart/form-data">
            @csrf
